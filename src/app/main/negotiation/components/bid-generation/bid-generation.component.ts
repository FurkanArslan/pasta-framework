...
@Component({
    ...
    templateUrl: './bid-generation.component.html',
    styleUrls: ['./bid-generation.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class BidGenerationComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private onPromoteSelection(scope): void {
        scope.createAutomatedMessage('Please select which values will promoted with this bid');
    }
